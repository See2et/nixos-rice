...

{
  ...
  home.activation.alvrPreferHardwareEncoding = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
    ...
    if [ -f "$session_file" ]; then
      ...
      if ${pkgs.jq}/bin/jq '
        .openvr_config.force_sw_encoding = false
        | .session_settings.video.encoder_config.software.force_software_encoding = false
